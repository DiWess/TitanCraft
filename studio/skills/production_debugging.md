...
Execute a repeatable Production Debugging workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `production debugging` or when routing indexes require this workflow.
