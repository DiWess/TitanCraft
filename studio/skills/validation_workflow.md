...
Run the Validation Workflow with concrete evidence and fail-closed verdicts.

## when_to_use

Use when a task routes to `validation_workflow` or when validating Agent Studio structure.
