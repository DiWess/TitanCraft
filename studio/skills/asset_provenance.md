...
Execute a repeatable Asset Provenance workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `asset provenance` or when routing indexes require this workflow.
