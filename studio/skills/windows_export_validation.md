# Skill: Windows Export Validation

## purpose

Execute a repeatable Windows Export Validation workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `windows export validation` or when routing indexes require this workflow.
