# Skill: Godot Runtime Contracts

## purpose

Execute a repeatable Godot Runtime Contracts workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `godot runtime contracts` or when routing indexes require this workflow.
