...
Execute a repeatable Pull Request Review workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `pull request review` or when routing indexes require this workflow.
