# Skill: Screenshot Critique

## purpose

Execute a repeatable Screenshot Critique workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `screenshot critique` or when routing indexes require this workflow.
