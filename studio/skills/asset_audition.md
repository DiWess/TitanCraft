# Skill: Asset Audition

## purpose

Execute a repeatable Asset Audition workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `asset audition` or when routing indexes require this workflow.
