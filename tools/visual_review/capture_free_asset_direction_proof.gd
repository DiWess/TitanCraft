...
const WIDTH := 1280
const HEIGHT := 720
const MAIN_SCENE := "res://scenes/Proof/FreeAssetDirectionProof.tscn"

const VIEWS := [
	{"name":"freeproof_01_hero_composition","position":Vector3(-10.0,5.0,12.0),"target":Vector3(0.0,1.0,-2.0),"fov":70.0},
	{"name":"freeproof_02_crashed_ship_three_quarter","position":Vector3(-9.0,3.2,4.0),"target":Vector3(0.0,0.9,-3.5),"fov":58.0},
	{"name":"freeproof_03_ship_engine_rear","position":Vector3(6.5,2.8,-8.0),"target":Vector3(0.0,0.8,-3.0),"fov":55.0},
	{"name":"freeproof_04_galaxabrain_view","position":Vector3(8.0,2.6,-2.0),"target":Vector3(5.6,1.0,-5.8),"fov":48.0},
	{"name":"freeproof_05_workbench_beacon_view","position":Vector3(0.0,3.0,8.0),"target":Vector3(5.0,1.2,0.0),"fov":60.0},
	{"name":"freeproof_06_mechanical_arm_view","position":Vector3(-3.0,2.2,7.0),"target":Vector3(0.0,1.1,4.0),"fov":50.0},
	{"name":"freeproof_07_wide_terrain_view","position":Vector3(-13.0,7.0,13.0),"target":Vector3(0.0,0.5,-2.0),"fov":78.0}
]
