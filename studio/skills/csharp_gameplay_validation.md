# Skill: Csharp Gameplay Validation

## purpose

Execute a repeatable Csharp Gameplay Validation workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `csharp gameplay validation` or when routing indexes require this workflow.
