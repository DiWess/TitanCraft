...
Execute a repeatable Prompt Design workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `prompt design` or when routing indexes require this workflow.
