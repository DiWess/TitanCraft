...
Execute a repeatable Evidence Reporting workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `evidence reporting` or when routing indexes require this workflow.
