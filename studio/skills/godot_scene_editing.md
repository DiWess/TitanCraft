# Skill: Godot Scene Editing

## purpose

Execute a repeatable Godot Scene Editing workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `godot scene editing` or when routing indexes require this workflow.
