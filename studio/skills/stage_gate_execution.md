# Skill: Stage Gate Execution

## purpose

Execute a repeatable Stage Gate Execution workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `stage gate execution` or when routing indexes require this workflow.
