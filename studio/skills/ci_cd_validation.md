...
Execute a repeatable Ci Cd Validation workflow that produces evidence, blockers, and an approved verdict without vague progress claims.

## when_to_use

Use when a task mentions `ci cd validation` or when routing indexes require this workflow.
